...
export const countryOptions: CountryOption[] = [
  ...
  { code: 'KP', name: 'North Korea', aliases: ['Korea, North'] },
  { code: 'KR', name: 'South Korea', aliases: ['Korea', 'Korea, South', 'Republic of Korea'] },
  { code: 'KW', name: 'Kuwait' },
...
export function getCountryOption(code: string): CountryOption | undefined {
  ...
  return countryOptions.find((country) => country.code === normalized);
}
